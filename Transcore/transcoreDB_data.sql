...
USE transcoredb;
INSERT INTO priority (pri_num, pri_text) 
VALUES 
  ('p0', 'Critical'), 
  ('p1', 'High Importance'), 
  ...
  ('p3', 'Low Importance'), 
  ('p4', 'Optional');
INSERT INTO requirements (req_num, req_desc) 
VALUES 
...
WHERE 
  track_id IN (
    163, 157, 57, 37, 154, 142, 56, 99, 139, 
    106
  );
