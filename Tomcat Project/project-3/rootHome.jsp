...
<head>
  ...
  #results tr:nth-child(odd) {
            background-color: darkgray; /* Light gray background for odd rows */
        }
...
//Handle the pages changing, handling of inputArea,servlet handling, will make changes if need be, works for now
        function executeCommand(event) {
            event.preventDefault(); // Prevent the default form submission

            var xhr = new XMLHttpRequest();
            var query = document.getElementById('inputArea').value;
            xhr.open('POST', '/project-3/RootUserServlet', true);
...
<body>
    ...
    <hr>
<p class="userlog">You are conected to the Project 3 Enterprise System database as a <em>root-level</em> user.<br> Please enter any SQL query or update command in the box below.</p>
    <div class="textBox">
